 ...
 *
 * Depois de validar o formulário, os dados digitados são usados para criar
 * um objeto Usuario (classe de modelo) e o aluno é enviado de volta para a
 * tela de Login para efetuar o primeiro acesso — assim como o fluxo indicado
 * no protótipo (cadastro -> login).
 */
public class CadastroActivity extends AppCompatActivity {
    ...
    /**
     * Função principal desta tela: valida os dados do formulário de cadastro
     * e, se estiverem corretos, cria o Usuario e volta para a tela de Login.
     */
